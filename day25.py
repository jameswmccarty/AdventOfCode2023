...
if __name__ == "__main__":
	...
	nodes['kbr'].discard('bbg')
	nodes['bbg'].discard('kbr')
	nodes['fht'].discard('vtt')
	nodes['vtt'].discard('fht')
	nodes['tdk'].discard('czs')
	nodes['czs'].discard('tdk')
	
	print(bfs('fht',nodes)*bfs('vtt',nodes))
